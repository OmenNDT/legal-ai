from backend.common.config import SUMMARY_WEIGHTS
from backend.common.text_processor import segment_sentences
from backend.summarizer.textrank import (
    build_similarity_matrix, textrank, compute_position_scores, select_sentences,
)
from backend.summarizer.sentence_scorer import PhoBERTSentenceScorer
