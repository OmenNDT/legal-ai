...
from backend.rag_pipeline.contracts import ProcessedQuestion, RetrievedDocument, RetrievalResult
from backend.rag_pipeline.query_expansion import expand_query
from backend.rag_pipeline.retrieval_utils import (
...
class LegalRetriever:
    ...
    def _load_docs_cache(self):
        ...
        try:
            from backend.common.config import PROCESSED_DIR
