...
from src.pipeline.query_understanding import QueryUnderstanding
from src.pipeline.retrieval import Retrieval
from src.pipeline.reranking import ReRanking
from src.pipeline.reasoning import Reasoning
from src.pipeline.post_processing import PostProcessing, FinalResponse
...
class RAGPipeline:
    ...
    def _init_search(self):
        ...
        if self._config.use_postgres_bm25 and self._db:
            from src.search.postgres_bm25 import PostgresBM25
