#!/usr/bin/env python3
"""Generate PowerPoint presentation (Light Theme) for Hybrid Summarization on CUAD."""
...
BG_SEC     = RGBColor(0xF1, 0xF5, 0xF9)
ACCENT     = RGBColor(0x25, 0x63, 0xEB)
ACCENT_L   = RGBColor(0x3B, 0x82, 0xF6)
GREEN      = RGBColor(0x05, 0x96, 0x69)
ORANGE     = RGBColor(0xD9, 0x77, 0x06)
RED        = RGBColor(0xDC, 0x26, 0x26)
PURPLE     = RGBColor(0x7C, 0x3A, 0xED)
CYAN       = RGBColor(0x08, 0x91, 0xB2)
DARK       = RGBColor(0x0F, 0x17, 0x2A)   # text primary
GRAY       = RGBColor(0x47, 0x55, 0x69)   # text secondary
MUTED      = RGBColor(0x94, 0xA3, 0xB8)  # text muted
...
def add_stat_card(slide, left, top, value, unit, label, val_color=ACCENT_L):
    card = add_card(slide, left, top, Inches(2.6), Inches(1.3), BORDER)
    tf = card.text_frame
    tf.word_wrap = True
    tf.paragraphs[0].alignment = PP_ALIGN.CENTER
...
add_textbox(slide, Inches(1.5), Inches(1.5), Inches(10.3), Inches(1.2),
            "Hệ thống Tóm tắt Văn bản Lai", font_size=40, color=DARK, bold=True,
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Tại sao không thể tóm tắt trực tiếp?", font_size=28, color=DARK, bold=True)
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Luồng dữ liệu tổng quát — Hybrid Pipeline", font_size=28, color=DARK, bold=True)
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Preprocess — Từ raw text → danh sách câu sạch", font_size=28, color=DARK, bold=True)
...
for i, (title, desc, color) in enumerate(preprocess_items):
    ...
    card = add_card(slide, Inches(0.8), top, Inches(5.5), Inches(1.5), BORDER)
    tf = card.text_frame
    tf.word_wrap = True
    tf.paragraphs[0].text = title
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Extractive — 3 thuật toán + Ensemble", font_size=28, color=DARK, bold=True)
add_textbox(slide, Inches(0.8), Inches(1.6), Inches(10), Inches(0.4),
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Abstractive — BART-large-CNN viết lại", font_size=28, color=DARK, bold=True)
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Evaluate — \"Tóm tắt vàng\" từ CUAD + Đánh giá", font_size=28, color=DARK, bold=True)
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Fine-tune BART trên CUAD — RTX 3090 24GB", font_size=28, color=DARK, bold=True)
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Backend Flask API (port 9020) + Frontend React", font_size=28, color=DARK, bold=True)
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Kiến trúc thư mục dự án", font_size=28, color=DARK, bold=True)

card = add_card(slide, Inches(0.8), Inches(1.8), Inches(5.5), Inches(5.0), BORDER)
tf = card.text_frame
tf.word_wrap = True
...
card = add_card(slide, Inches(6.8), Inches(1.8), Inches(5.7), Inches(5.0), BORDER)
tf = card.text_frame
tf.word_wrap = True
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Phụ lục — Các tham số cấu hình chính", font_size=28, color=DARK, bold=True)

card = add_card(slide, Inches(0.8), Inches(1.8), Inches(11.7), Inches(3.8), BORDER)
tf = card.text_frame
tf.word_wrap = True
...
add_textbox(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.6),
            "Hạn chế hiện tại & Hướng phát triển", font_size=28, color=DARK, bold=True)
...
# ── Save ──
output_path = "/home/sontn/Projects/legal-ai/slides/presentation-light.pptx"
